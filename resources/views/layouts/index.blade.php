...
<!-- Mirrored from htmlstream.com/preview/front-v3.2.2/html/landings/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Nov 2020 13:34:43 GMT -->

<head>
  <!-- Title -->
  <title>Welcome Page | Memdal IT Services</title>
  ...
  <!-- Favicon -->
  <link rel="shortcut icon" href="{{ asset('img/mockups/favicon-32x32.png') }}">
...
<body>
          ...
          <div id="navBar" class="collapse navbar-collapse">
            <div class="navbar-body header-abs-top-inner">
              <ul class="navbar-nav">
                <!-- Home -->
                <!-- About -->
                <li class="navbar-nav-item" data-hs-mega-menu-item-options='{
                      "desktop": {
                        "position": "right",
                        "maxWidth": "900px"
                      }
                    }'>
                  <a id="demosMegaMenu" class="hs-mega-menu-invoker nav-link" href="/aboutmemdal"
                      ...
                      <div class="col-lg-5">
                        ...
                        <div class="navbar-banner" style="background-image: url({{ asset('img/750x750/img1.jpg') }});">
                          <div class="navbar-banner-content">
                            <div class="mb-4">
                              <span class="h2 d-block text-white">Memdal IT Services</span>
                              <p class="text-white">Experience a level of our quality in both design &amp; development
                                works.</p>
                            </div>
                            <a class="btn btn-color btn-sm transition-3d-hover" href="#">Learn More <i
                                class="fas fa-angle-right fa-sm ml-1"></i></a>
                          </div>
                        </div>
                        <!-- End Banner Image -->
                      ...
                      <div class="col-lg-7">
                        <div class="row mega-menu-body">
                          <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            <a class="dropdown-item" href="classic-analytics.html">Web Development</a>
                            <a class="dropdown-item" href="classic-consulting.html">IT Consulting</a>
                            <a class="dropdown-item" href="classic-consulting.html">IT Support</a>
                            <a class="dropdown-item" href="classic-consulting.html">Application Services</a>
                            <a class="dropdown-item" href="classic-consulting.html">UI&amp;UX Design</a>
                            <a class="dropdown-item" href="classic-portfolio.html">
                              Search Engine Optimization<span class="badge badge-danger badge-pill ml-2">SEO</span>
                            </a>
                            <a class="dropdown-item" href="classic-consulting.html">Web Design </a>
                            <a class="dropdown-item" href="classic-consulting.html">Graphics Design</a>
                ...
                <li class="hs-has-sub-menu navbar-nav-item">
                  ...
                  <div id="pagesSubMenu" class="hs-sub-menu dropdown-menu" aria-labelledby="pagesMegaMenu"
                    ...
                    <!-- Account and Inventory System -->
                    <div>
                      <a id="navLinkPagesCompany" class="hs-mega-menu-invoker dropdown-item"
                        href="javascript:;" aria-haspopup="true" aria-expanded="false"
                        aria-controls="navSubmenuPagesCompany">Account & Inventory System</a>
                    </div>
                    <!-- Account & inventory Stystem -->
                    ...
                    <!-- Management Systems -->
                    <div>
                      <a id="navLinkContactsServices" class="hs-mega-menu-invoker dropdown-item"
                        href="javascript:;" aria-haspopup="true" aria-expanded="false"
                        aria-controls="navSubmenuContactsServices">Management Systems</a>
                    </div>
                    <!-- Management Systems -->
                  </div>
                  <!-- End Pages - Submenu -->
                ...
                <li class="navbar-nav-last-item">
                  <a class="btn btn-sm btn-color transition-3d-hover"
                    href="contacts-agency.html">
                    Contact Us
                  </a>
                </li>
                <!-- End Button -->
      ...
      <div class="space-top-2 space-bottom-1 space-bottom-lg-2">
        <div class="row justify-content-lg-between">
          <div class="col-lg-3 ml-lg-auto mb-5 mb-lg-0">
            ...
            <div class="mb-4">
              <a href="index.html" aria-label="Front">
                <img class="brand" src="{{ asset('img/mockups/memdal-transparent.png') }}"
                  alt="Logo">
              </a>
            </div>
            <!-- End Logo -->
                ...
                <a class="nav-link media" href="javascript:;">
                  <span class="media">
                    ...
                    <span class="media-body">
                      164 Pius Street, 4th Avenue, F.H.A Airport Road, Abuja, Nigeria.
                    </span>
                  </span>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link media" href="tel:+2348102555913">
                  <span class="media">
          ...
          <div class="col-6 col-md-3 col-lg mb-5 mb-lg-0">
            ...
            <!-- Nav Link -->
            <ul class="nav nav-sm nav-x-0 nav-white flex-column">
              <li class="nav-item"><a class="nav-link" href="/aboutmemdal">About</a></li>
              <li class="nav-item"><a class="nav-link" href="#">Careers <span class="badge badge-primary ml-1">We're
                    hiring</span></a></li>
              ...
              <form class="js-validate">
                ...
                <div id="login">
                  ...
                  <div class="text-center mb-7">
                    <h3 class="mb-0">Sign In to Dashboard</h3>
                  ...
                  <div class="mb-3">
                    <button type="submit" class="btn btn-sm btn-color btn-block">Sign In</button>
                  </div>
                  ...
                  <a class="btn btn-sm btn-ghost-secondary btn-block mb-2" href="#">
                    <span class="d-flex justify-content-center align-items-center">
                      <img class="mr-2" src="{{ asset('img/750x750/img1.jpg') }}" alt="Image Description" width="14"
                        height="14">
                      Sign In with Google
                    </span>
                  </a>
                ...
                <div id="signup" style="display: none; opacity: 0;">
                  ...
                  <div class="js-form-message mb-4">
                    ...
                    <div class="input-group input-group-sm mb-2">
                      <input type="password" class="form-control" name="confirmPassword" id="signupConfirmPassword"
                  ...
                  <div class="mb-3">
                    <button type="submit" class="btn btn-sm btn-color btn-block">Sign Up</button>
                  </div>
                  ...
                  <a class="btn btn-sm btn-ghost-secondary btn-block mb-2" href="#">
                    <span class="d-flex justify-content-center align-items-center">
                      <img class="mr-2" src="{{ asset('img/160x160/img17.png') }}" alt="Image Description" width="14"
                        height="14">
                      Sign Up with Google
                    </span>
                  </a>
                ...
                <div id="forgotPassword" style="display: none; opacity: 0;">
                  ...
                  <div class="js-form-message">
                    ...
                    <div class="input-group input-group-sm mb-2">
                      <input type="email" class="form-control" name="email" id="recoverEmail" placeholder="Your email"
                        aria-label="Your email" required data-msg="Please enter a valid email address.">
                    </div>
                  </div>
                  <!-- End Input Group -->

                  <div class="mb-3">
                    <button type="submit" class="btn btn-sm btn-color btn-block">Recover Password</button>
                  </div>
  ...
  <script>
    if (/MSIE \d|Trident.*rv:/.test(navigator.userAgent)) document.write(
      '<script src="{{ asset('vendor/polifills.js') }}"><\/script>');
  </script>
</body>

<!-- Mirrored from htmlstream.com/preview/front-v3.2.2/html/landings/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Nov 2020 13:38:25 GMT -->
