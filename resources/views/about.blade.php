      ...
      <div class="row mx-n2 mb-5">
          ...
          <div class="card h-100 transition-3d-hover">
            <div class="card-body">
              <div class="avatar avatar-lg avatar-circle mb-4">
                <img class="avatar-img" src="{{ asset('img/100x100/img1.jpg') }}" alt="Image Description">
              </div>
        ...
        <div class="col-sm-6 col-lg-3 px-2 mb-3">
          ...
          <div class="card h-100 transition-3d-hover">
            <div class="card-body">
              <div class="avatar avatar-lg avatar-circle mb-4">
                <img class="avatar-img" src="{{ asset('img/100x100/img3.jpg') }}" alt="Image Description">
              </div>
        ...
        <div class="col-sm-6 col-lg-3 px-2 mb-3">
          ...
          <div class="card h-100 transition-3d-hover">
            <div class="card-body">
              <div class="avatar avatar-lg avatar-circle mb-4">
                <img class="avatar-img" src="{{ asset('img/100x100/img11.jpg') }}" alt="Image Description">
              </div>
